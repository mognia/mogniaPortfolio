...
const SocialTitle = styled.h3`
  ...
  background: linear-gradient(90deg, #1c7287, #27beb3); /* Gradient effect on text */
...
const SocialDescription = styled.p`
  ...
  .highlight {
    color: #27beb3; /* Highlighted purple color for important words */
  }
`;
...
const SocialIcons = styled.div`
  ...
  a {
    ...
    &:hover {
      color: #1c7287; /* Change icon color to purple on hover */
    }
  }
`;
